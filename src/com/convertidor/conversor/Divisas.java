package com.convertidor.conversor;

import com.convertidor.app.MensajeFinal;
import javax.swing.ImageIcon;
import javax.swing.JOptionPane;

public class Divisas {
    // Carga los íconos para mostrar en el cuadro de diálogo
    ImageIcon icon = new ImageIcon(getClass().getResource("/com/convertidor/icons/icon-divisa.png"));
    ImageIcon iconM = new ImageIcon(getClass().getResource("/com/convertidor/icons/icon-error.png"));
