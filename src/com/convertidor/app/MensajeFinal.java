...
public class MensajeFinal {
    ...
    ImageIcon iconP = new ImageIcon(getClass().getResource("/com/convertidor/icons/icon-question.png"));
    ImageIcon iconE = new ImageIcon(getClass().getResource("/com/convertidor/icons/icon-salir.png"));
